...
app.config["MONGO_URI"] = 'mongodb+srv://root:NecfIPUD5PTBlYMe@practicecluster-tjxfj.mongodb.net/task_manager?retryWrites=true&w=majority'
...
@app.route('/update_cateogry/<category_id>', methods=['POST'])
